...
def test_dict_intercepts():
    """Test the _calculate_intercept helper method in Dict"""
...
def test_dict(Simulator, nl_nodirect):
    ...
    def make_dict(**kwargs):
        model = Dict(nl_nodirect(n), n/float(num_items), d_key, d_value,
                     **kwargs)
        with model:
        ...
        return model, output_p, dopamine_p
